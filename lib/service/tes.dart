...
//     Widget tabSemua = FutureBuilder<List<dynamic>>(
...
//                           context,
//                           MaterialPageRoute(
//                               builder: (context) => const DetailComic()));
//                     },
//                     child: Column(
//                       children: <Widget>[
//                         Container(
...
//     Widget tabManga = FutureBuilder<List<dynamic>>(
//       future: ComicService.getDataComicManga(),
//       builder: (context, snapshot) {
//         if (snapshot.connectionState == ConnectionState.waiting) {
//           return const Center(child: CircularProgressIndicator());
//         } else {
...
//     Widget tabManhua = FutureBuilder<List<dynamic>>(
//       future: ComicService.getDataComicManhua(),
//       builder: (context, snapshot) {
//         if (snapshot.connectionState == ConnectionState.waiting) {
//           return const Center(child: CircularProgressIndicator());
//         } else {
...
//     Widget tabManhwa = FutureBuilder<List<dynamic>>(
//       future: ComicService.getDataComicManhwa(),
//       builder: (context, snapshot) {
//         if (snapshot.connectionState == ConnectionState.waiting) {
//           return const Center(child: CircularProgressIndicator());
//         } else {
