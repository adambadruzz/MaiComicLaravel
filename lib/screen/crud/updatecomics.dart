...
class _UpdateComicsState extends State<UpdateComics> {
  TextEditingController idcomic = TextEditingController();
  ...
  uploadData() async {
    ...
    var responseApi =
        await dio.put('$baseUrlApi/comic/$id', data: uploadDataData);
